...
alias lfetch='fastfetch --config examples/8.jsonc'
alias trfetch='fastfetch --config examples/20.jsonc'
alias mfetch='fastfetch --config $XDG_CONFIG_HOME/fastfetch/macchina.jsonc'
