...
#actions[switchuser]="???"
actions[logout]="i3-resurrect save -w 1 && i3-resurrect save -w 2 && loginctl terminate-session ${XDG_SESSION_ID-}"
actions[suspend]="systemctl suspend"
actions[hibernate]="systemctl hibernate"
actions[reboot]="i3-resurrect save -w 1 && i3-resurrect save -w 2 && systemctl reboot"
actions[shutdown]="i3-resurrect save -w 1 && i3-resurrect save -w 2 && systemctl poweroff"
